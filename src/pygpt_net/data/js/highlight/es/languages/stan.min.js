...
},contains:[e.C_LINE_COMMENT_MODE,r,e.HASH_COMMENT_MODE,t,{scope:"built_in",
match:/\s(pi|e|sqrt2|log2|log10)(?=\()/,relevance:0},{
match:_.concat(/[<,]\s*/,_.either(...i),/\s*=/),keywords:i},{scope:"keyword",
match:/\btarget(?=\s*\+=)/},{
